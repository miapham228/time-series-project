...
ets_metrics <- accuracy(ets_forecast, test_values)
arima_metrics <- accuracy(arima_forecast, test_values)
nnar_metrics <- accuracy(nnar_forecast, test_values)
...
The ARIMA model performs the best among all models, with the lowest RMSE, MAE, and MAPE, indicating the highest prediction accuracy and the smallest error.
...
The NNAR model performs the worst, with the highest RMSE, MAE, and MAPE, indicating that it has the highest prediction error and the lowest accuracy.
